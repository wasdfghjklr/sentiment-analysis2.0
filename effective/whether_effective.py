...
torch.save(train_loader, './datasetloader/train_loader-electra-180g-small-64-32-32-256.pt')
torch.save(val_loader, './datasetloader/val_loader-electra-180g-small-64-32-32-256.pt')
torch.save(test_loader, './datasetloader/test_loader-electra-180g-small-64-32-32-256.pt')
...
#---------train model---------#
OUT_PATH = "./dataset_results_model/electra-180g-small-64-32-32-256/"
...
for epoch in range(epochs):
    ...
    train_loader = torch.load(
        './datasetloader/train_loader-electra-180g-small-64-32-32-256.pt')
    ...
    val_acc = 0.0
    val_f1 = 0.0
    val_loader = torch.load('./datasetloader/val_loader-electra-180g-small-64-32-32-256.pt')
...
start = time.time()
test_loader = torch.load('./datasetloader/test_loader-electra-180g-small-64-32-32-256.pt')
