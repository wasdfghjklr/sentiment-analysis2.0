...
def train_and_evaluate(model, train_data, val_data, optimizer, scheduler, params, model_dir, restore_dir=None):
    ...
    if restore_dir is not None:
        ...
        model = AutoModelWithLMHead.from_pretrained(tagger_model_dir)
...
if __name__ == '__main__':
    ...
    tagger_model_dir = 'experiments/based_gpt2_base'
    ...
    if args.dataset in ["conll"]:
        ...
        # bert_class = './pretrained_bert_models/FinBERT_L-12_H-768_A-12_pytorch'
        bert_class = './pretrained_bert_models/gpt2_zh_base'
    ...
    # model = GPT2LMHeadModel.from_pretrained(bert_class, num_labels=len(params.tag2idx))
